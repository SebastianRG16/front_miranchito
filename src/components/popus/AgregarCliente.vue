<template>
  <div
    class="top-10 left-0 z-[1055] h-full w-full overflow-y-auto overflow-x-hidden outline-none transition duration-300"
  >
    <div
    ...
    >
      ...
      >
        ...
        <form @submit.prevent="agregarCliente" class="px-8">
